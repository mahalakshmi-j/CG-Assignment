...
void circle(float rad)
{
    ...
    {
        glVertex2i(rad * cos(i), rad * sin(i));// drawing a single-pixel dot to the
...
void orbital(float x, float y, float z, char *string)
{
    glColor3f(0, 1, 0);
    glRasterPos3f(x, y, z);
...
void display()
{
    ...
    if (value == -1)
    {
        char cn[] = "BMS INSTITUTE OF TECHNOLOGY AND MANAGEMENT";
        drawhead(-500, 900, 0, cn);

        char dn[] = "DEPARTMENT OF COMPUTER SCIENCE & ENGINEERING";
        drawhead(-490, 650, 0, dn);

        char pro[] = "VISUALIZATION OF ATOMIC STRUCTURES";
        drawhead(-400,350, 0, pro);

        char pb[] = "PROJECT BY: ";
        drawhead(-650, -150, 0, pb);

        char p1[] = "MAHALAKSHMI J";
        drawhead(-650, -250, 0, p1);
        char p1u[] = "1BY18CS087";
        drawsubhead(-650, -300, 0, p1u);

        char p2[] = "MANISHA M";
        drawhead(-650, -400, 0, p2);
        char p2u[] = "1BY18CS090";
        drawsubhead(-650, -450, 0, p2u);

        char gb[] = "GUIDED BY: ";
        drawhead(290, -150, 0, gb);

        char g1[] = "Mr.SHANKAR R";
        drawhead(290, -250, 0, g1);
        char d1[] = "Assistant Professor, Dept. Of CSE, BMSIT";
    ...
    if (value == 3)
    {
        ...
        char orb1[]="S";
        circle(400);
        orbital(410, 50, 0, orb1);
        char orb2[]="P";
        circle(600);
        orbital(610, 50, 0, orb2);
        char o[] = "ORBIT";
...
int main(int argc, char **argv)
{
    ...
    glutCreateWindow("VISUALIZATION OF ATOMIC STRUCTURES");
    init();
